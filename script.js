class ToastManager {
    ...
    createToastElement(type, message, duration = 5000) {
        ...
        // Build toast DOM safely to prevent XSS — never use innerHTML with user-supplied content
        ...
        messageEl.textContent = message; // textContent escapes HTML, preventing XSS

        const closeBtn = document.createElement('button');
        closeBtn.className = 'toast-close';
        closeBtn.setAttribute('aria-label', 'Close');
        closeBtn.textContent = '×';
        closeBtn.addEventListener('click', () => this.removeToast(toastId)); // avoids inline onclick
