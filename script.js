class ToastManager {
    ...
    createToastElement(type, message, duration = 5000) {
        ...
        // Build child elements using DOM APIs to prevent XSS from unsanitized message content
        ...
        messageEl.textContent = message; // textContent prevents HTML injection (XSS)
