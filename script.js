class ToastManager {
    ...
    // Escape a string so it is safe to render as text content
    sanitizeText(str) {
    ...
    createToastElement(type, message, duration = 5000) {
        ...
        // Build child elements manually to avoid injecting unsanitized HTML via innerHTML
        ...
        messageEl.textContent = message; // textContent is safe — no HTML interpretation
